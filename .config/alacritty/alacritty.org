...
** Old Hope
Old Hope color scheme.  Anchored as "old_hope"
Adapted from [[https://github.com/mohkale/an-old-hope-theme][An Old Hope]] by [[https://github.com/mohkale][mohkale]].
Utilized work from [[https://github.com/theherk][theherk]]/[[https://github.com/theherk/an-old-hope-alacritty][an-old-hope-alacritty]] for this port.
#+BEGIN_SRC yaml :tangle alacritty.yml
# Colors (Old Hope)
  old_hope: &old_hope
  # Default colors
...
* Select Color Scheme
Select a color scheme by specifying colors: *old_hope
| Color Scheme   | Anchor         |
|----------------+----------------|
