...
colorBgNormalList =     ["#282828",      "#002b36",        "#282a36"] --normal bg
colorBgBrightList =     ["#3b3838",      "#113b3f",        "#36343f"] --lighter bg
trayerBgNormalList =    ["0x00282828",   "0x00002b36",     "0x00282a36"] --trayer tint
colorFgNormalList =     ["#ebdbb2",      "#839496",        "#f8f8f2"] --normal fg
color01NormalList =     ["#343428",      "#073642",        "#000000"] --black
color01BrightList =     ["#928374",      "#002b36",        "#555555"] --bright black
color02NormalList =     ["#cc241d",      "#dc3ddf",        "#ff5555"] --red
color02BrightList =     ["#fb4934",      "#cb4b16",        "#ff1010"] --bright red
color03NormalList =     ["#98971a",      "#859900",        "#50fa7b"] --green
color03BrightList =     ["#b8bb26",      "#586e75",        "#02fe03"] --bright green
color04NormalList =     ["#d79921",      "#b58900",        "#f1fa8c"] --yellow
color04BrightList =     ["#fabd2f",      "#657b83",        "#ffff02"] --bright yellow
color05NormalList =     ["#458588",      "#268bd2",        "#bd93f9"] --blue
color05BrightList =     ["#83a598",      "#839496",        "#4d31fd"] --bright blue
color06NormalList =     ["#b16286",      "#d33682",        "#ff79c6"] --magenta
color06BrightList =     ["#d3869b",      "#6c71c4",        "#ff20d8"] --bright magenta
color07NormalList =     ["#689d6a",      "#2aa198",        "#8be9fd"] --cyan
color07BrightList =     ["#8ec07c",      "#93a1a1",        "#03feff"] --bright cyan
color08NormalList =     ["#a89984",      "#eee8d5",        "#bbbbbb"] --white
color08BrightList =     ["#ebdbb2",      "#fdf6e3",        "#ffffff"] --bright white
colorFocusList =        ["#458588",      "#859900",        "#ff79c6"] --focus and run launcher color
